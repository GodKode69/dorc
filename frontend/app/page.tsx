...
export default function Home() {
  ...
  const handleImageSelect = useCallback(async (file: File) => {
    ...
    try {
      ...
      const res = await fetch("https://api.godkode.xyz/predict", {
        method: "POST",
        body: formData,
      });
    ...
    <div style={{
      ...
      <header style={{
        ...
        <span style={{
          ...
          108 CLASSES &middot; EFFICIENTNET-B0 &middot; ONNX
        </span>
      </header>

      {/* Main */}
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        {/* Left: Upload — centered when idle, shifted left when result */}
        <div style={{
